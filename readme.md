...
- the source code for the [website](https://egg-0x6x.onrender.com/)
- the code for the original, terminal input/output simulation

As a disclaimer, I am not a programmer nor web developer. Thus, I don't do coding professionally, and so this code is probably rather hard to understand and chaotic. If you have questions, reach out to me!
...
- Snapshots of a certain configuration can be saved. They can be exported/imported as text, the text can also be manipulated manually
- the edit mode allows to edit anything, ignoring cash, time or shifts
- if you would like to run the website locally, simply run `python app.py` and visit `http://localhost:5000/` with your browser
